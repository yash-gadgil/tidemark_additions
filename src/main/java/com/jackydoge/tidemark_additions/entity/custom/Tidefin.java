...
public class Tidefin extends AbstractFish implements GeoEntity {

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public Tidefin(EntityType<? extends AbstractFish> entityType, Level level) {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllerRegistrar) {
        controllerRegistrar.add(new AnimationController<>(this, "swim_controller", 0, event -> {
            ...
            event.getController().setAnimation(RawAnimation.begin().thenLoop("animation.tidefin.swim"));
